...
fun main() {
    ...
    val lastFoundFile = File("$rootPath/src/main/kotlin/blogPostManage/LastFoundIdx.txt")
    val postedProblemFile = File("$rootPath/src/main/kotlin/blogPostManage/PostedProblems.txt")
